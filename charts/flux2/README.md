...
![Version: 2.17.1](https://img.shields.io/badge/Version-2.17.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.7.3](https://img.shields.io/badge/AppVersion-2.7.3-informational?style=flat-square)
...
| helmController.tag | string | `"v1.4.3"` |  |
...
| imageAutomationController.tag | string | `"v1.0.3"` |  |
...
| imageReflectionController.tag | string | `"v1.0.3"` |  |
...
| kustomizeController.tag | string | `"v1.7.2"` |  |
...
| notificationController.tag | string | `"v1.7.4"` |  |
...
| sourceController.tag | string | `"v1.7.3"` |  |

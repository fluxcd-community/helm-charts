...
![Version: 1.0.1](https://img.shields.io/badge/Version-1.0.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.31.5](https://img.shields.io/badge/AppVersion-0.31.5-informational?style=flat-square)
...
| helmcontroller.tag | string | `"v0.22.2"` |  |
...
| imageautomationcontroller.tag | string | `"v0.23.5"` |  |
...
| imagereflectorcontroller.tag | string | `"v0.19.4"` |  |
...
| kustomizecontroller.tag | string | `"v0.26.3"` |  |
...
| notificationcontroller.tag | string | `"v0.24.1"` |  |
...
| sourcecontroller.tag | string | `"v0.25.11"` |  |

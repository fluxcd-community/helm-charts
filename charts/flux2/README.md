...
![Version: 0.19.2](https://img.shields.io/badge/Version-0.19.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.31.0](https://img.shields.io/badge/AppVersion-0.31.0-informational?style=flat-square)
...
| helmcontroller.tag | string | `"v0.22.0"` |  |
...
| imageautomationcontroller.tag | string | `"v0.23.0"` |  |
...
| imagereflectorcontroller.tag | string | `"v0.19.0"` |  |
...
| kustomizecontroller.tag | string | `"v0.26.0"` |  |
...
| sourcecontroller.tag | string | `"v0.25.3"` |  |

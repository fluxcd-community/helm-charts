...
![Version: 1.1.0](https://img.shields.io/badge/Version-1.1.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.32.0](https://img.shields.io/badge/AppVersion-0.32.0-informational?style=flat-square)
...
| imageautomationcontroller.tag | string | `"v0.24.1"` |  |
...
| imagereflectorcontroller.tag | string | `"v0.20.0"` |  |
...
| kustomizecontroller.tag | string | `"v0.27.0"` |  |
...
| notificationcontroller.tag | string | `"v0.25.1"` |  |
...
| sourcecontroller.tag | string | `"v0.26.1"` |  |

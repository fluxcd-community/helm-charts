...
![Version: 2.16.0](https://img.shields.io/badge/Version-2.16.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.6.1](https://img.shields.io/badge/AppVersion-2.6.1-informational?style=flat-square)
...
| imageAutomationController.tag | string | `"v0.41.0"` |  |
...
| imageReflectionController.tag | string | `"v0.35.1"` |  |
...
| sourceController.tag | string | `"v1.6.0"` |  |

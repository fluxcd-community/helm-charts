...
![Version: 0.20.0](https://img.shields.io/badge/Version-0.20.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.31.1](https://img.shields.io/badge/AppVersion-0.31.1-informational?style=flat-square)
...
| imageautomationcontroller.tag | string | `"v0.23.2"` |  |
...
| imagereflectorcontroller.tag | string | `"v0.19.1"` |  |
...
| kustomizecontroller.tag | string | `"v0.26.1"` |  |
...
| sourcecontroller.tag | string | `"v0.25.5"` |  |

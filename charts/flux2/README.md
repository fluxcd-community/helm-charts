...
![Version: 2.18.0](https://img.shields.io/badge/Version-2.18.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.8.1](https://img.shields.io/badge/AppVersion-2.8.1-informational?style=flat-square)
...
| helmController.tag | string | `"v1.5.1"` |  |
...
| imageAutomationController.tag | string | `"v1.1.0"` |  |
...
| imageReflectionController.tag | string | `"v1.1.0"` |  |
...
| kustomizeController.tag | string | `"v1.8.1"` |  |
...
| notificationController.tag | string | `"v1.8.1"` |  |
...
| sourceController.tag | string | `"v1.8.0"` |  |
...
| sourceWatcher.tag | string | `"v2.1.0"` |  |
